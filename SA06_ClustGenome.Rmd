...
#ds.ds <- PCA(ds.ds, do.print = TRUE, pcs.print = 20, genes.print = 20)
...
# Load object from our analysis
#ds.ds <- readRDS("objects/genome_pc30.rds")

# Excluding cells that express histone proteins outside the male germline clusters
...
#identify cells to be excluded using do.identify = TRUE in Seurat function TSNEPlot()
...
At this stage the data set includes `r length(ds.g.s1@meta.data$nGene)` cells with a median of `r median(ds.g.s1@meta.data$nGene)` genes and a median of `r median(ds.g.s1@meta.data$nUMI)` UMIs per cell. We cluster the cells as before, annotate the t-SNE representation (Fig. \ref{fig:annottsne}) and plot metagenes from NMF analysis wg_K84 (Fig. \ref{fig:metagenes}). \
